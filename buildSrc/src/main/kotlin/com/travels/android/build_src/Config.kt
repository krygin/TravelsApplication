...
object Dependencies {
    ...
    const val androidArchitecturePersistenceRoomRuntime = "android.arch.persistence.room:runtime:1.1.1"
    const val androidArchitecturePersistenceRoomCompiler = "android.arch.persistence.room:compiler:1.1.1"
    const val androidArchitecturePresistenceRoomRxJava = "android.arch.persistence.room:rxjava2:1.1.1"
    ...
    const val retrofitRxJavaAdapter = "com.squareup.retrofit2:adapter-rxjava2:2.4.0"
